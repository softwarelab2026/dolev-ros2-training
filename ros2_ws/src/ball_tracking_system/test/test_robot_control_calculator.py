...
def test_mapping_coordinates_to_the_middle_of_turtlesim_screen() -> None:
    x, y = map_coordinate_to_turtlesim_coordinates(200, 200, 400, 400)
    assert x == 5.5 and y == 5.5


def test_mapping_coordinates_to_the_right_top_corner_of_turtlesim_screen() -> None:
    x, y = map_coordinate_to_turtlesim_coordinates(400, 400, 400, 400)
    assert x == 11 and y == 0


def test_mapping_coordinates_to_the_left_bottom_corner_of_turtlesim_screen() -> None:
    x, y = map_coordinate_to_turtlesim_coordinates(0, 0, 400, 400)
    assert x == 0 and y == 11


def test_mapping_coordinates_to_the_right_bottom_corner_of_turtlesim_screen() -> None:
    x, y = map_coordinate_to_turtlesim_coordinates(400, 0, 400, 400)
    assert x == 11 and y == 11


def test_velocity_to_ball_when_turtle_same_y_with_ball(simple_pid: PID) -> None:
    turtle_pose = Pose()
    turtle_pose.x = 0.0
    turtle_pose.y = 0.0
...
def test_velocity_to_ball_when_turtle_same_x_with_ball(simple_pid: PID) -> None:
    turtle_pose = Pose()
    turtle_pose.x = 0.0
    turtle_pose.y = 10.0
...
def test_velocity_to_ball_when_turtle_on_different_x_and_y(simple_pid: PID) -> None:
    turtle_pose = Pose()
    turtle_pose.x = 0.0
    turtle_pose.y = 10.0
...
def test_angular_velocity_to_ball_when_ball_is_45_degrees_from_turtle(
    simple_pid: PID,
) -> None:
    turtle_pose = Pose()
    turtle_pose.x = 0.0
...
def test_angular_velocity_to_ball_when_ball_is_135_degrees_from_turtle(
    simple_pid: PID,
) -> None:
    turtle_pose = Pose()
    turtle_pose.x = 5.0
...
def test_angular_velocity_to_ball_when_ball_is_270_degrees_do_normalize_so_it_will_be_negative_90(
    simple_pid: PID,
) -> None:
    turtle_pose = Pose()
    turtle_pose.x = 5.0
